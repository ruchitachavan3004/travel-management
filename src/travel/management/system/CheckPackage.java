...
public class CheckPackage extends JFrame{
    ...
    CheckPackage() {    
      ...
      setVisible(true);
      String[] package1 = new String[]{"package1.jpg","INTERNATIONAL PACKAGE","6 days and 7 Nights", "Airport Assistance at Aiport", "Half Day City Tour", "Welcome drinks on Arrival", "Daily Buffet", "Full Day 3 Island Cruise", "English Speaking Guide", "BOOK NOW", "Summer Special", "Rs 45000 only"};
      String[] package2 = new String[]{"package2.jpg","DOMESTIC PACKAGE","4 days and 3 Nights", "Toll Free and Entrance Free Tickets", "Meet and Greet at Aiport", "Welcome drinks on Arrival", "Night Safari", "Full Day 3 Island Cruise", "Cruise with Dinner", "BOOK NOW", "Winter Special", "Rs 30000 only"};      
