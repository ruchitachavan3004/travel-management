...
class CreatePackage extends JFrame implements ActionListener{
   ...
   //   private String UserName,Password,Status;
    ...
    tid=new JTextField();
    tid.setBounds(120, 70, 180, 30);
    c.add(tid);
    
    tname=new JTextField();
    tname.setBounds(120, 120, 180, 30);
    c.add(tname);
    
   tdate=new JTextField();
    tdate.setBounds(120, 170, 180, 30);
    c.add(tdate); 
    
    tcost=new JTextField();
    tcost.setBounds(120, 220, 180, 30);
    c.add(tcost);
    ...
    log.setBounds(276, 300, 100, 50);
    log.addActionListener(this);
    c.add(log);
    
    save=new JButton("Save");
    save.setBounds(146, 300, 120, 50);
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       {
        new Dashboard(clickbutton).setVisible(true);
        setVisible(false);
       }
